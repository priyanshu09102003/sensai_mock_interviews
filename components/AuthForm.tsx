    ...
    <div className="card-border lg:min-w-[566px]">
        <div className="flex flex-col gap-6 card py-14 px-10">
            <div className="flex flex-row gap-2 justify-center">
                    ...
                    <Image src="/sensai.svg" alt="logo" height={34} width={135} />
            </div>

            <h3 className="text-center text-lg font-normal">Where AI Meets Ambition</h3>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="w-full space-y-6 mt-4 form">
                ...
                <Button type="submit" className="cursor-pointer btn">{isSignIn ? 'Sign In' : 'Create an Account'}</Button>
            </form>
            </Form>
